	...
	<div class="down-main">
					...
					<ul class="navContent" style="display: block">
						<li>
							<div class="showtitle" style="width: 100px;">
								<img src="images/leftimg.png">远程定位
							</div> <a target="trackList"
							href="loraDemo.jsp?usrname=<%=sName %>&type=small"> <span
								class="sublist-icon glyphicon glyphicon-map-marker"></span> <span
								class="sub-title">远程定位</span></a>
						</li>
						<li>
							<div class="showtitle" style="width: 100px;">
								<img src="images/leftimg.png">设备管理
							</div> <a target="trackList" href="UserDevManager.html?name=<%=sName%>">
								<span class="sublist-icon glyphicon glyphicon glyphicon-cloud"></span>
						...
						<li>
							...
							href="jsp/Area_BeaconManager.html?name=<%=sName %>"> <span
		...
		<div class="right-product my-index right-full">
			<iframe width="100%" scrolling="auto" height="100%"
				...
				src="loraDemo.jsp?usrname=<%=sName %>&type=small" id="rightMain"
