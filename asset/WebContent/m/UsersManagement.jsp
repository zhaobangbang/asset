...
<body>
	...
	<div style="padding: 0 5px 0 0;">
		...
		<ul class="unstyled defaultlist">
			<li class="a" style="float: left;"><a href="GateWayManager.html">
					<h3>网关管理</h3>
					<figure class="hb_icon">
						<img src="Img/2.png" width="100%" height="100px">
					</figure>
			</a></li>
			<li class="p"><a href="CityManager.html?name=<%=sName %>">
					<h3>区域管理</h3>
					<figure class="mp_icon">
						<img src="Img/4.png" width="100%" height="100px">
					</figure>
			</a></li>
		</ul>
		<ul class="unstyled defaultlist">
			<li class="t" style="float: left;"><a
				href="MyselfManager.jsp?name=<%=sName %>">
					<h3>个人信息</h3>
					<figure>
						<img src="Img/5.png" width="100%" height="100px">
					</figure>
			</a></li>

			<li class="m"><a href="RegisterCode.html">
					<h3>注册码管理</h3>
					<figure>
						<img src="Img/6.png">
					</figure>
