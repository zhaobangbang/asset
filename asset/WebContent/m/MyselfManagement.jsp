...
<body>
	...
	<div style="padding: 0 5px 0 0;">
		<ul class="unstyled defaultlist pt20">
			<li class="f"><a
				href="loraDemo.jsp?usrname=<%=sName %>&type=small">
					<h3>远程定位</h3>
					<figure class="jp_icon">
						<img src="Img/7.png" width="100%">
					</figure>
			</a></li>
			<li class="h"><a href="UserDevManager.html?name=<%=sName%>">
					<h3>设备管理</h3>
		...
		<ul class="unstyled defaultlist">
			<li class="a"><a
				href="html/warningmgr/UserDevAlarm.html?name=<%=sName%>">
					<h3>告警日志</h3>
			...
			<li class="p"><a
				href="html/baidumap/paramset.html?name=<%=sName%>">
					<h3>参数设置</h3>
		...
		<ul class="unstyled defaultlist">
			<li class="t"><a href="MyselfManager.jsp?name=<%=sName%>">
					<h3>信息管理</h3>
					<figure>
