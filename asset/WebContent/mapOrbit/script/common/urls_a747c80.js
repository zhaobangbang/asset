define('script/common/urls', function(require, exports, module) {
  ...
  var urls = {
      ...
      post: function post(url, params, success, before, fail, after) {
          ...
          params.ak = _commonfun2['default'].getQueryString('T3esAl5i0NHA9SAEHF3dRyauqTazR2bf');
          params.service_id = _commonfun2['default'].getQueryString('118042');
          if(params.filter == null){
        	  params.filter = 'owner:' + _commonfun2['default'].getQueryString('owner');
          }else{
        	  params.filter = params.filter + '|' + 'owner:' + _commonfun2['default'].getQueryString('owner');
          } 
          $.ajax({
              type: 'POST',
              url: url,
  ...
  //# sourceMappingURL=/asset/mapOrbit/script/common/urls.js.map
