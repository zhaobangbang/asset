define('script/common/mapControl', function(require, exports, module) {
  ...
  window.mapControl = {
      ...
      initMap: function initMap() {
          ...
          canvasScript.src = '/asset/mapOrbit/static/javascript/CanvasLayer_037cb6d.js';
      ...
      */
      ...
      setMonitorInfoBox: function setMonitorInfoBox(data) {
          ...
          this.monitorInfoBox = new BMapLib.InfoBox(map, infoContentFrontArr.concat(infoContentNextArr).join(''), {
              ...
              alignBottom: false,
              closeIconUrl: '/asset/mapOrbit/static/images/closeinfowindow_3dcf4b6.png'
          });
      ...
      setEntityMarker: function setEntityMarker(data, service_type) {
          ...
          if (service_type === 1) {
              ...
              switch (status.substring(0, 2)) {
                  case '离线':
                      iconUrl = '/asset/mapOrbit/static/images/caroffnorth_14ea3dd.png';
                      break;
                  case '静止':
                      iconUrl = '/asset/mapOrbit/static/images/carstaticnorth_91acd73.png';
                      break;
                  default:
                      iconUrl = '/asset/mapOrbit/static/images/carrunnorth_603ab7f.png';
                      break;
              }
          } else {
              ...
              switch (status.substring(0, 2)) {
                  case '离线':
                      iconUrl = '/asset/mapOrbit/static/images/othertypeoffline_1dd9f51.png';
                      break;
                  case '静止':
                      iconUrl = '/asset/mapOrbit/static/images/othertypestatic_fa33f89.png';
                      break;
                  default:
                      iconUrl = '/asset/mapOrbit/static/images/othertype_2964e8e.png';
                      break;
              }
          }
  ...
  //# sourceMappingURL=/asset/mapOrbit/script/common/mapControl.js.map
