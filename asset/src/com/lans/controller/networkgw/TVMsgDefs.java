package com.lans.controller.networkgw;
...
public class TVMsgDefs {
	...
	public static final byte UL_DEV_COORDINATE = 0x8;
	public static final byte UL_DEV_BRACELET = 0x9;
	public static final byte UL_GW_HB = 0xE;
