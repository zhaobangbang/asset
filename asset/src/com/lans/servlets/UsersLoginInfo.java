...
/**
 * Servlet implementation class UsersLoginInfo
 */
@WebServlet("/UsersLoginInfo.do")
public class UsersLoginInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (oper){
        case "load": {
        	resp = JqueryGridDBAccess.load(dbm, "users_login_tbl", postMap);
        	logger.info("respond to post in UsersLoginInfo.do "+resp.toString());
        ...
        case "add": {
        	...
        	JqueryGridDBAccess.insert(dbm, "users_login_tbl", postMap);
        	break;
        }
        
        case "del":{
        	JqueryGridDBAccess.delete(dbm, "users_login_tbl", postMap);
        	break;
        }
        
        case "edit":{
        	JqueryGridDBAccess.update(dbm, "users_login_tbl", postMap);
        	break;
        }
