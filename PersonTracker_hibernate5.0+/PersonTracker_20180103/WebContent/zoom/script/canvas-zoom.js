...
(function () {
    ...
    CanvasZoom.prototype = {
        animate: function () {
            ...
            DrawMarkerInfo(this.scale.x * this.scaleAdaption, this.scale.y * this.scaleAdaption, this.position.x + this.positionAdaption.x, this.position.y + this.positionAdaption.y);
            DrawRangInfo(this.scale.x * this.scaleAdaption, this.scale.y * this.scaleAdaption, this.position.x + this.positionAdaption.x, this.position.y + this.positionAdaption.y);
            requestAnimationFrame(this.animate.bind(this));
        },
                ...
                window.addEventListener('mousedown', function (e) {
                	...
                	for(var i = markerInfo.length-1; i >= 0; i--) {
                        ...
                        if(this.flag) {
                        	...
                        	$("#deveui").val(''+this.previousSelectedCircle.deveui);
                        	$("#vib").val(''+this.previousSelectedCircle.vib);
                        	$("#rssi").val(''+this.previousSelectedCircle.rssi);
                        	$("#battery").val(''+this.previousSelectedCircle.battery);
                        	$("#time").val(''+this.previousSelectedCircle.time);
                    		this.flag = false;
                    	}
                      }
